...
if($estado == 0){
 ...
 ?>
	...
	<div class="row row-list estado-<?php echo $estado ?> tarefa-single" id="<?php echo $dados['id_tarefa'];?>" style="margin: 5vh auto;<?php if($estado==2){echo "border-bottom:4px solid black !important;";}?><?php if($process==1){echo "border-bottom:4px solid #5093e1 !important;";}?><?php if($urg==1){echo "border-bottom:4px solid red;";}?>">
		...
		<a href = "listar_tarefa.php?id=<?php echo $dados['id_tarefa']; ?>&linktodas=<?php echo $actual_link; ?>">
			...
			<div class="col-md-1"> <h5><strong>Seleccionar Tarefa</strong> <br><br><i class="fa fa-check bulk-check"></i> </h5></div>
