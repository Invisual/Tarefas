...
header('Content-Type: application/json');
        ...
        $data=array();
        $q=mysqli_query($con,"SELECT * FROM tarefas INNER JOIN clientes on tarefas.cliente_id = clientes.id_cliente where processada= '0' GROUP BY id_tarefa ORDER BY id_tarefa DESC");
