...
.modal-tarefa button{
    ...
    $(document).ready(function(){
            ...
            arrTarefas = arrTarefasInteiro.tarefas.filter(function(tar){
               return tar.id_cliente.includes(options.cliente) && tar.estado.includes(options.estado) && tar.tipo_tarefa.includes(options.tipo) && tar.faturada.includes(options.modofaturacao);
            });
         
        } else {
            arrTarefas = arrTarefasInteiro.tarefas.filter(function (tar) {
                return tar.id_cliente.includes(options.cliente) && tar.intervenientes.indexOf(options.colaborador) != -1 && tar.estado.includes(options.estado) && tar.tipo_tarefa.includes(options.tipo) && tar.faturada.includes(options.modofaturacao);
            });
        }
