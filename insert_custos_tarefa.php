...
<title>INVISUAL - Adicionar Custos de Tarefa</title>
...
if(!empty($_POST)){
	...
	try{		
		...
		$insert = $log->insertCustosTarefa($idtarefa, $servicos, $custosfornecedor, $custosvenda, $nomefornecedor, 1);
...
<div class="row-form-holder form-titulo-cliente-desc">
	...
	<h2>Custos Fornecedores e Valores de Venda</h2>
	...
	<div class="inputs-rows">
		...
		<div class="row rowcustostarefa">
			...
			<div class="col-md-2">
				...
				<input type="text" id="nomefornecedorinput" name="nomefornecedor[]" />
			</div>

			<div class="col-md-5">
				<label for="servicosinput">Produto/Serviço</label>
				<textarea id="servicosinput" name="servicos[]"></textarea>
			</div>


			<div class="col-md-2">
				<label for="fornecedorinput">Custo Fornecedor</label>
				<input type="number" min=0 step=0.01 id="fornecedorinput" name="custosfornecedor[]" />
			</div>


			<div class="col-md-2">
				<label for="vendainput">Custo de Venda</label>
				<input type="number" min=0 step=0.01 id="vendainput" name="custosvenda[]" />
			</div>

			<div class="col-md-1 delete-row"><i class="fa fa-trash"></i></div>
...
<div class="submit-btn-holder">
	<input type="submit" class="form-control btn btn-primary btn-submit-form" value="Adicionar" id="submit">
</div>
