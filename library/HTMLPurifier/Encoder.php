...
class HTMLPurifier_Encoder
{
     ...
     * Source: //www.w3.org/TR/REC-xml/#NT-Char
     * Arguably this function should be modernized to the HTML5 set
     * of allowed characters:
     * //www.w3.org/TR/html5/syntax.html#preprocessing-the-input-stream
     ...
     *       hsivonen@iki.fi at <//iki.fi/hsivonen/php-utf8/> under the
     ...
     *       <//forums.devnetwork.net/viewtopic.php?p=191404#191404>,
    ...
    public static function convertToUTF8($str, $config, $context)
    {
        ...
        if ($bug == self::ICONV_OK) {
            ...
            trigger_error(
                'You have a buggy version of iconv, see //bugs.php.net/bug.php?id=48147 ' .
                'and //sourceware.org/bugzilla/show_bug.cgi?id=13541',
                E_USER_ERROR
            );
        }
    }
