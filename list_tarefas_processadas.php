    ...
    $(document).ready(function(){
            ...
            function assignDataToArray(){
                ...
                if(options.colaboradores == ''){
                    arrTarefas = arrTarefasInteiro.tarefas.filter(function(tar){
                        return tar.id_cliente.includes(options.cliente) && tar.faturada.includes(options.faturada) && tar.tipo_tarefa.includes(options.tipo)
                    });
                }
                else{
                    arrTarefas = arrTarefasInteiro.tarefas.filter(function(tar){
                        return tar.id_cliente.includes(options.cliente) && tar.faturada.includes(options.faturada) && tar.intervenientes.includes(options.colaboradores) && tar.tipo_tarefa.includes(options.tipo)
                    });
                }
                ...
                for(var i = 0, count=arrTarefas.length; i<count; i++){
                    ...
                    if(arrTarefas[i].dias_tarefa.some(function(r){return r.split('/')[1].includes(options.mes)})){
